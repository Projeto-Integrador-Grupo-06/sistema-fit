package com.generation.projetointegradorfitness.configuration;
	...
	OpenAPI springSistemaFitOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Integrador Fitness").description("Projeto Integrador Sistema Fitness")
						...
						.contact(new Contact().name("Grupo 06 - Generation Brasil").url("https://github.com/Projeto-Integrador-Grupo-06/sistema-fit")
								.email("grupo06turmajava84@gmail.com")))
				.externalDocs(
						new ExternalDocumentation().description("Github").url("https://github.com/Projeto-Integrador-Grupo-06/sistema-fit/"))
